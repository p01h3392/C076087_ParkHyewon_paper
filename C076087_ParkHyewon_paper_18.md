...
> > > ##### 시각 변증법
 * 시각 변증법은 충돌 몽타주의 기초가 되는 미학적 원리이다. 이러한 변증법 개념은 영화와 다큐멘터리의 전체 서술 구조에도 적용된다. 
 * 변증법은 본디 명백한 모순을 근거로 보편적인 참된 진실에 도달한다. 러시아의 후기 영화 이론가이자 감독인 세르게이 아이젠슈타인과 같은 사람들은 변증법을 몽타주의 기본 구조 및 주제 원칙, 전체 영화의 기본 맥락으로 사용했다. 헤겔의 경우 정, 반, 합이라는 3단계에 따라 변증법이 전개된다고 보았는데, 모순을 지각해 부딪힘으로써 제 3의 합으로 이어진다고 주장하였다. 이는 충돌 몽타주와 유사한 원리이다. 에이젠슈타인은 변증법적 방식, 즉 상반되는 아이디어를 충돌시키는 방식으로 장면들과 전체 시퀀스를 배치했다. 따라서 전체 영화가 복잡한 시각적 변증법을 보여준다. 그러나 이러한 시각 변증법의 공적인 적용은 스크린에서 발생하는 사건의 미적 에너지를 고갈시켜 지루하게 만들 수 있다. 비디오 뿐만 아니라 영화에서도 시각 변증법의 무분별한 사용은 미적 요소를 손상시킬 수 있다. 변증법적 방법에 비해 벡터 이론은 에너지 생산을 위해 벡터가 충돌할 필요가 없다는 장점이 있다. 시각적 변증법은 벡터의 영역에 포함되지만 종속되지는 않는다. 

+ 세르게이 에이젠슈타인이 제시한 5가지 몽타주
 1. 미터법(Metric) 몽타주 - 영화 작품의 절대 길이를 기준으로 하는 몽타주
 2. 리듬 몽타주 - 프레임 내의 내용이 각 숏의 길이를 결정하는 몽타주. 각종 벡터에 의해 컷이 나눠져 전체 몽타주의 벡터 필드를 결정한다.
 3. 음조(Tonal)  몽타주 - 작품의 특징적인 정서적 사운드에 의해 주도된다. 정서적 강도의 정도를 반영하며, 불안정성을 나타내는 수평선 등의 예시가 있다.
 4. 배음(Overtonal) 몽타주 - 작품의 지배적인 음과 배음의 결합에서 파생된 몽타주. 비교 또는 충돌 몽타주가 여기 포함된다. 기본 몽타주에 조명의 변화와 같은 미묘한 배음이 있을때에도 발생한다.
 5. 지적 몽타주 : 주제인 내용에 기반을 두는 몽타주. 인지적으로 통제되며, 감정이나 직관만이 아니라 지성에 의한 폐쇄를 요구한다. 

----------------------------------------------------------

> ### 미터법(Metric) 몽타주
 * 세르게이 에이젠슈타인이 명명한 리드미컬한 구조화 장치 역할을 하는 몽타주. 다소 균등한 간격으로 화면에 표시되는 일련의 이미지들로 구성된다. 개별 샷 내의 내용이나 연속성, 색상에 관계없이 푸티지를 거의 같은 샷 길이로 자르기만 하면 만들 수 있다. 이러한 정밀한 3차 움직임의 리듬은 몽타주를 일반적인 샷 순서와 구별하는 중요한 특징이다. 
 * 미터법 몽타주에서의 변형은 가속 미터법 몽타주로, 샷이 점점 짧아진다. 이를 이용하여 장면의 특정 고점에 도달하게 하거나 강조할 수 있다. 

-----------------------------------------------------------------------

> ### 오디오/비디오 몽타주 
 * 분석 몽타주와 아이디어 몽타주는 특정한 사운드 트랙과 나란히 배치하여 생성하거나 보강할 수 있다. 특히 아이디어 몽타주에 유리하다. 오디오 트랙을 사용하면 대부분의 경우 충돌이나 비교 몽타주를 눈에는 덜 띄지만 효과는 있도록 만드는 것이 쉽다. 

> > #### 순차 분석 A/V 몽타주
 * 시각적 순차 분석 몽타주의 오디오는 일반적으로 시각적 시퀀스를 따르는 문자적 사운드와 음악으로 구성된다. 공항으로 달려가는 모습을 보여주는 몽타주에서 자동차 경적이나 호흡 소리, 비행기 소리 등을 넣는 것이 그 예시이다. 이후 리드미컬하게 정확한 음악 트랙을 추가함으로써 몽타주의 시각적 연속성을 촉진하고 리듬 구조를 강화할 수 있다.

> > > ##### 단면 분석 몽타주
 * 단면 분석 몽타주가 서로 다른 환경을 보여주는 경우, 한 사운드 환경에서 다음 환경으로 시각적으로 간단히 잘라낼 수 있다. 예를 들어 도심의 쇼핑 지역을 구경하는 인물의 단면 몽타주를 보여주면, 묘사된 장소의 사운드 특성을 가지고 각 샷을 동행하게 된다. 백화점 소리 등에서 다음 소리 환경까지 자를 수 있다. 이때에는 소리가 사건의 진행을 받쳐주는 것이 아니라 환경을 모자이크처럼 구성한다. 음향은 수평 벡터보다 수직 벡터에 기여한다. 혹은 백화점 사운드와 같은 단일 사건의 사운드 트랙을 몽타주 전체에서 실행하게끔 할 수 있다. 이렇게 하면 필요한 몽타주 연속성을 제공할 수 있다. 리듬이 정확한 음악 역시 동일한 구조적 기능을 수행한다. 

> > > ##### 비교 아이디어 연관 몽타주 
 * 비교 몽타주에서는 암시적으로 3차적 의미를 형성하는 소리를 선택할 수 있다. 예를 들어 빨간 스포츠카가 달리는 움직임을 보여주고, 오디오로 전투기 엔진 소리를 삽입하면 자동차가 제트기만큼 빠르다는 것을 보여줄 수 있다. 또 텅 빈 축구장에서 노인이 걷고 있을때 시끄러운 군중 소리를 보여주면, 이는 노인이 선수였던 시절의 기억을 전달한다. 

> > > ##### 충돌 아이디어 연관 몽타주
 * 충돌 몽타주에 수반되는 사운드 트랙은 화면에 보이는 것과 의미와 느낌 면에서 모순된다. 그러나 전체적으로는 시각적 장면을 강화하거나 3차적 의미를 형성한다. 예를 들어 폭력적인 장면을 강화하기 위해 부드럽고 낭만적인 음악으로 시각적인 것에 대항하는 것이다. 
 * 빈민 지역의 클로즈업에 도시와 부에 관해 설명하는 나레이션을 넣으면, 이는 빈민촌의 악조건들을 강화한다. 시의원들이 도시가 곤경에 처해 있다는 것을 깨닫지 못하는 듯한 메시지를 전달할 수 있다. 또 공격용 헬기의 영상에 로맨틱한 음악을 삽입하면, 이는 전쟁의 부조리함을 날카롭게 만든다. 
 * 오디오/비디오 충돌 몽타주는 적은 노력으로 큰 효과를 낼 수 있다. 그저 시청자의 기대에 어긋나는 문자 그대로의 소리를 사용하면 된다. A/V 충돌 몽타주는 노골적이지는 않지만 사용 방법과 시기에 신중해야 한다. 예를 들어 항공사 재난의 영상과 왈츠를 동반하는 것은 공감력을 높이기는 커녕 오히려 뉴스 부서의 무감각함을 보여줄 수 있다. 

-----------------------------------------------

> ### 미디어 미학과 인간의 상태
 * 이 책은 인간의 상태(조건)에 대처하고 반영하며 개선하는 데에 도움이 되는 아이디어를 기반으로 작성되었다. 인간의 조건이라 함은 우리가 우리 자신을 어떻게 보고, 미디어에서 자신을 묘사하고, 우리가 건설한 분열된 세계를 재 해석하고 살아가는 것을 의미한다. 
 * 모든 사람에게 공통된 불변의 현실은 없으며, 현실은 우리 각자가 어떻게, 어떤 맥락에서 그것을 보는지에 따라 크게 좌우된다. 보름달이 이를 구경하는 연인과 착륙 장소를 찾는 과학자에게 다르게 보이는 것처럼, 서로 다른 맥락은 우리가 사건을 인식하고 해석하는 방식을 변경한다. 
 * 우리는 한 개인이자 대중적인 사회의 의사소통자로서 재구성에 대해 책임을 져야 한다. 인간 상태에 대한 새로운 통찰력과 디지털 혁명은 큰 도전과 기회를 제공한다. 우리의 과제는 중요한 사건들을 식별하고, 동료 인간들을 위해 미디어를 통해 그것들을 명확화, 강화, 해석하는 것이다. 기회는 이를 상상력, 창의적, 스타일적으로 보여주게끔 돕는다. 응용 미디어 미학은 이러한 작업에 두움을 준다. 
 * 스토리텔링은 인간의 일반적인 상태와 관련이 있어왔으며, 이는 줄곧 변하지 않았다. 변화된 것은 우리가 인간의 상태를 보는 방식과 이야기를 전달하는 방식이다. 여러 사건들을 누구에게나 전달할 수 있는 미디어는 우리의 세계관을 극적으로 변화시켰으며, 인간의 상태를 있는 그대로, 혹은 잠재적으로 지구상의 모든 사람들에게 보여줄 수 있게 해 주었다. 그러나 최선의 의도에도 불구하고 무언가를 전달하려는 노력은 다소 미완성으로 남는다. 이러한 불완전성은 일상 생활의 일부분이다. 
 * 어떠한 이야기를 말할 때 미디어 미학의 원리를 적용하면, 이는 우리가 필연적으로 우리 주변의 세계에 대해 더 잘 인식하게 만들고, 모순되는 관점에 관대하게 만들고, 궁극적으로는 지혜를 가지고 우리의 열정을 잘 다룰 수 있게 한다. 마지막 조언으로, 창의적이게 되라는 말은 항상 장관을 추구해야 한다는 것을 의미하지는 않는다. 대신 평상시에도 평범하지 않은 것들을 보기 위해 자세히 연민을 가지고 보아야 한다. 그런 다음 미적 도구를 사용하여 동료 인간을 위해 인간의 조건의 작은 부분이라도 명확히 하고, 강화하고, 해석할 수 있다. 
 * 어린 왕자에서 여우는 '사람이 올바르게 볼 수 있는 것은 오직 마음으로, 본질적인 것은 눈에 보이지 않는 것이다'라고 말한다. 우리의 일은 보이지 않는 것을 보이게 하는 것이다. 
