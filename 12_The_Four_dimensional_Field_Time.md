...
--------------------------------------------------------------------
 ...
 > ### 시간이란 무엇인가?
  * 우리는 시간을 측정할 수는 있지미만, 이를 정확히 알지 못한다. 우리는 오직 현재에서만 살 수 있으며, 현재를 넘어서려고 할 때에는 어러 문제에 부딫히게 된다.     
  * 시간이라는 개념이 얼마인지에 대해 물어보면, 사람들은 다 다르게 대답할 것이다. 이 문제에 대해 J. T. Frasser는 시간을 '익숙한 낯선 사람' 이라고 부른다. 
  * 시간에 대해 아는 것은 우리의 미디어인 비디오와 영화가 가장 관련있어보이는 사건과 동작의 층면을 선택하고, 논의하고, 4차원 영역을 구성하는 데에 도움이 된다. 
