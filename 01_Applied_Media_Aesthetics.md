 ...
 * 우리의 행동은 특정한 메세지가 어떻게 전달되는지에 대해 큰 영향을 미친다. 같은 인사말도 미소 / 노려보는 시선에 따라 메시지가 바뀐다.    
  ...
  * Zwangdes Mediums(매체의 힘) : 게르하르트 말레츠케는 메시지의 내용에만 분석하던 많은 학자들과 달리,     
     메시지의 형성에 영향을 미치는 것은 문화적 또는 미학적 선호일 뿐만 아니라 '매체의 힘'일 수 있다고 주장했다.     
     매체들은 중립적이지 않으며, 이는 창조적인 행위의 최종 결과물에 결정적인 영향을 미친다.      
     같은 메시지더라도 와이드스크린 디지털 시네마와 휴대폰 디스플레이용 메시지 디자인 등 다른 방식으로 전달해야 한다.      
     ->  미디어 미학의 적용 대상 : 미디어가 특정한 시청자의 반응에 대한 메시지를 만드는가가 미디어 미학의 적용 대상이다.    
