 ...
 * 윈도우 박싱과 마찬가지로, 16 * 9 화면 중앙에 4 * 3 크기의 이미지를 배치한다. 그러나 필러 박싱에서는 4 * 3 이미지 프레임의 상단과 하단이 16 * 9 사진 공간과 일치하도록 한다. 
   ...
   > > >  ##### 래터박싱 (Letterboxing)
 * 래터박싱은 1.85 : 1 영화, 16 * 9(1.78 : 1) 의 디지털 비디오, 4 * 3(1.33 : 1) 화면, 또는 수직의 모바일 디스플레이 등에 폭넓게 쓰인다.     
      와이드스크린의 래터박스는 원본 형식의 전체 너비와 높이를 표시하고, 화면 상단과 하단을 검은색, 흰색이나 컬러 막대로 가리는 방식으로 이루어진다.        
      와이드스크린 HDTV 형식은 대부분 잘리지 않고 동영상 사진을 수용하게끔 개발되었다. 이러한 기능은 이미지가 작을 수록 대역폭이 절약되므로 더 많은 정보를 기록 미디어로 전송하거나 압축할 수 있는 기술적인 이유 때문에 만들어졌다. 휴대전화와 같은 작은 디스플레이에도 래터박스는 타 종류의 종횡비를 수용하게끔 조정해준다.     
