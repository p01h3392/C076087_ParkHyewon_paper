 ...
 * 롱 숏과 클로즈업은 화면에 나타나는 물체의 크기뿐만 아니라, 시청자에게 가깝게 보이는 정도에 따라 달라진다. 우리는 시야의 변화를 실제 신체적, 심리적 거리의 변화로 인식하기에, 이미지를 볼 때에도 유사하게 반응한다. 어떤 문화권에서는 사람들이 대화할 때에 서로 훨씬 가까운 자리에 위치하는데, 이는 근접학(proxemics)이라고 불리는 현상이다.  
 * 
